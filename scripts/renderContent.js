	...
	}, [
		{
			...
			description: {
				'en': `
					...
					Role: Frontend Developer (Landing Page)<br>
					Technologies: Next.js, React, TypeScript, Tailwind CSS, Styled Components
				`,
				'ua': `
					Стартап-проєкт otake.io<br>
					Роль: Frontend розробник (landing page)<br>
					Технології: Next.js, React, TypeScript, Tailwind, Styled Components
				`
			},
			imageUrl: 'img/portfolio/otake-landing.png',
			// urlGitHub: 'https://www.termoblok.pp.ua/',
			urlVisit: 'https://otake.io/',
